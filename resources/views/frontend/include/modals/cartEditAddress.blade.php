<div class="modal fade edit_div" id="edit_cart_addrs_mod" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="edit_info">
                    <form class="editAddressForm" id="editAddressForm" method="POST" action="{{url('/user/deliverey/address/update')}}">
                        @csrf
