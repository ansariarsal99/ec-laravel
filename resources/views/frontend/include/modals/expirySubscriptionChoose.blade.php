<div class="modal fade modal_fit expry_plans" id="expirysubscription" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                      ...
                      <div class="from_reset">
                         <form role="form">
                              ...
                              <div class="modal-footer justify-content-center">
                                  <button type="button" class="btn btn_theme" id=""><span>Cancel</span></button>
