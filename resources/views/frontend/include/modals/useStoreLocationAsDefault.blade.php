    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Use Address</h5>
            ...
            <div class="modal-body">
                <div class="card_info text-center">
                      <p>Are you sure you want to use this address as default ?</p>
                    <form id="updateDefaultAddressForm" method="POST" action="{{url('/provider/storeLocation/default/update')}}" >
