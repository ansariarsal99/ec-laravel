<!-- Use Card modal -->
<div class="modal fade edit_div" id="subm_deadline_mod" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Change Submission Deadline</h5>
            ...
            <div class="modal-body">
                <div class="card_info text-center">
                    <form id="changeSubmissionDeadlineForm">
                        <div class="form-group">
                            <input type="text" onkeydown="return false" name="proposal_submission_deadline_date" class="form-control datetimepicker-input sbmsn_deadline" id="datetimepicker6" data-toggle="datetimepicker" data-target="#datetimepicker6" placeholder="Change Submission Date" />
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn_theme chng_sbmsn_btn"><span>Submit</span></button>
            </div>
        </div>
    </div>
</div>
