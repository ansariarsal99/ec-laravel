					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tbody>
								...
								<tr>
									<td align="left">
										<p style="margin-bottom:0px; font-size:18px; font-weight:bold; color: #505050;padding: 9px 30px 0px;">Dear, {{  ucfirst($seller_name) }} <span></span></p>
										<p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">

											 I want to cancel {{$product_name}},which i placed on {{$placed_on}},and my order no. is {{$order_id}}.<br />
											 
											<span style="font-weight: 600; color: #cc3f2f;">Your Reason:</span> {{$cancellationReason}}<br />
									</td>
								</tr>
