								...
								<tr>
									<td align="left">
										...
										<p style="padding: 9px 30px 40px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											Request For Proposal <span style="color:#cc3f2f;">{{@$data['request_title']}}</span> has been {{@$data['request_status']}} by <span style="color:#cc3f2f;">{{@ucwords($data['by_user'])}}.</span><br>
										</p>
