			...
			<tbody>
					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tbody>
								<tr>
									<td align="center">
										<span style="font-size:24px; color:#cc3f2f; font-weight: 700;">Refund Status</span><br />
										<span></span>
									</td>
								</tr>
								<tr>
									<td align="left">
										<p style="margin-bottom:0px; font-size:18px; font-weight:bold; color: #505050;padding: 9px 30px 0px;">Dear, {{  ucfirst($buyer_name) }} <span></span></p>
										<p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">

											 The refund status, for <span style="font-size:14px; color: #cc3f2f;">{{$product_name}}</span>, under order no. <span style="font-size:14px; color: #cc3f2f;">{{$order_id}}</span> which was placed on <span style="font-size:14px; color: #cc3f2f;">{{$placed_on}}</span>, is <span style="font-size:14px; color: #cc3f2f;">{{$order_status_type}}</span>.<br />
				...
				<tr>
					<td align="left">
						...
						<span style="display: block;margin: 0px 30px 20px;color: #cc3f2f;">{{$seller_name}}</span>
