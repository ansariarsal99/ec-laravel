					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tbody>
								<tr>
									<td align="center">
										<span style="font-size:24px; color:#cc3f2f; font-weight: 700;">Product Cancellation Request</span><br />
										<span></span>
									</td>
								</tr>
								<tr>
									<td align="left">
										...
										<p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											 ...
											 Your Cancellation Request for {{$product_name}}, under order no. {{$order_id}} which was placed on {{$placed_on}}, is Rejected by us.<br />
											 
											<span style="font-weight: 600; color: #cc3f2f;">Rejection Reason:</span> {{$cancellationReason}}<br />
									</td>
								</tr>
