...
<html>
<head>
	<title>Request For Proposal Submission Deadline Changed - Build Mart</title>
</head>
								...
								<tr>
									<td align="left">
										...
										<p style="padding: 9px 30px 30px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											Please be attention that a new submisssion date and time had been assigned for the RFP <span style="color:#cc3f2f;">{{@$data['request_title']}}.</span> Hope to receive your proposal as soon as possible.<br>
