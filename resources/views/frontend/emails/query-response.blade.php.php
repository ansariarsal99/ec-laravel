			...
			<tbody>
					...
					<td bgcolor="#fff">
						<table cellspacing="0" cellpadding="10" border="0" align="center" width="100%">
							<tbody>
								<tr>
									<td align="left">
										<img src="img/logo.png" alt="logo" width="150" height="">
									</td>
									<td align="right">
							...
							<tbody>
								<tr>
									<td style="vertical-align: middle;" align="center">
										<div class="logo-wrap">
		                                	<img src="img/mcoll.png" alt="logo" width="100%" height="300" style="object-fit: cover">
		                            	</div>
									</td>
								</tr>
							</tbody>
					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tbody>
								...
								<tr>
									<td align="left">
										<p style="margin-bottom:0px; font-size:18px; font-weight:bold; color: #505050;padding: 9px 30px 0px;">Dear, <span>{{@ucwords($data['name'])}}</span></p>
										<p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											<span style="font-weight: 600; color: #cc3f2f;">Your Question:</span><br /> {{ ucfirst($links['question_to_user']) }}
									</td>
								</tr>
								<tr>
									<td align="left">
										<p style="padding: 9px 30px 40px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
										<span style="font-weight: 600; color: #cc3f2f;">{{  ucfirst($links['name']) }} Response:</span><br /> {{ ucfirst($links['response_to_user']) }}
									</td>
								</tr>
				...
				<tr>
					<td align="left">
						...
						<span style="display: block;margin: 0px 30px 20px;color: #505050;">Team, MawadMart</span>
					</td>
				</tr>
				<tr>
