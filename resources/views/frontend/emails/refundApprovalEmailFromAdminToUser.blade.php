								...
								<tr>
									<td align="left">
										...
										<p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											 ...
											 The Approved refund status, for <span style="font-size:14px; color: #cc3f2f;">{{$product_name}}</span>, under order no. <span style="font-size:14px; color: #cc3f2f;">{{$order_id}}</span> which was placed on <span style="font-size:14px; color: #cc3f2f;">{{$placed_on}}</span>, is <span style="font-size:14px; color: #cc3f2f;">{{$order_status_type}}</span>.<br />
