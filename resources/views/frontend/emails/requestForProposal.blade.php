...
<html>
<head>
	<title>Request For Proposal - Mawad Mart</title>
</head>
								...
								<tr>
									<td align="left">
										...
										<p style="padding: 9px 30px 30px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											<span style="color:#cc3f2f;">{{@ucwords($data['by_user'])}}</span> has the pleasure to send you RFP <span style="color:#cc3f2f;">{{@$data['request_title']}}.</span><br>
