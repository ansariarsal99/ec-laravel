...
<html>
<head>
	<title>Request For Proposal Cancelled - Build Mart</title>
</head>
								...
								<tr>
									<td align="left">
										...
										<p style="padding: 9px 30px 30px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;">
											We apologize to inform you that your proposal for <span style="color:#cc3f2f;">{{@$data['request_title']}}</span> had been cancelled, we hope to deal together in near future.<br>
