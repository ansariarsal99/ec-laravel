...
@section('title','Designer Detail')
@section('content')
    <div class="pagntn">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:;">Home</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Designer List</a></li>
                <li class="breadcrumb-item active" aria-current="page">Designer Detail</li>
            </ol>
        </nav>
    </div>
