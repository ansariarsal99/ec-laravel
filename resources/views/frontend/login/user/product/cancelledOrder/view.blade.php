...
@section('title','View Cancelled Order Details')
@section('content')
	                ...
	                <section class="bread_top_sec">
	                    <div class="db_container">
	                        <div class="d-flex justify-content-between text-white pos_rel">
	                            ...
	                            <h3>View Cancelled Order Details</h3>
	                            <nav class="bread_nav_sec">
	                                <ol class="breadcrumb">
	                                    <li class="breadcrumb-item"><a href="javascript:;">Home</a></li>
	                                    <li class="breadcrumb-item active"><a href="javascript:;">View Cancelled Order Details</a></li>
