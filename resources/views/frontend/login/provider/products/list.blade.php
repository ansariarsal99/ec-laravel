                                ...
                                <div class="d-flex justify-content-between text-white pos_rel">
                                    ...
                                    <nav class="bread_nav_sec">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"><a href="javascript:;">Product Lists</a></li>
...
<script>
    $(function() {
        var t = $('#productList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('/provider/products/list/index')}}',
            columns: [
                ...
                // { data: 'mawad_mart_code',  name: 'mawad_mart_code'},
...
$(document).on('click','.delete-btn',function(e){
        ...
        swal({
          ...
          if (result.value) {
            $.ajax({
                 url: "{{ url('provider/products/delete') }}" + '/' + id,
...
<script type="text/javascript">
    $(document).on('click', '.drop-class', function(){
        ...
        $.ajax({
            ...
            type:'post',
            url: "{{ url('provider/products/change/status') }}",
                success:function(resp){
