                        ...
                        <div class="d-flex justify-content-between text-white pos_rel">
                            ...
                            <nav class="bread_nav_sec">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:;">Messages</a></li>
                                                                    ...
                                                                    <div class="scrll-bar">
                                                                        <ul class="chat_users clearfix" type="none">
                                                                            ...
                                                                            <!-- <li class="usr-msg-box d-flex align-items-center">
                                                                                <div class="usr-img">
                                                                                    <img src="img/client3.jpg" class="img-fluid" alt="abc"> 
                                                                                </div>
                                                                                <div class="meta_chat_info">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="chat-body"> 
                                                                ...
                                                                <!-- <div class="top-head_in d-flex align-items-center">
                                                                    <img class="img-fluid" src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />
                                                                    <span class="right_inf">
                                                                        <h5 class="nam_ch"> Jack Crimson <span class="pull-right"></span> </h5>
                                                                        <span class="act_stts text-success"><i class="fa fa-circle"></i> Active Now</span>
                                                                    </span>
                                                                </div>
