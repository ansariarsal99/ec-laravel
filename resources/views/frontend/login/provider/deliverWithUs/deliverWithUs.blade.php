                        ...
                        <div class="d-flex justify-content-between text-white pos_rel">
                            ...
                            <nav class="bread_nav_sec">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:;">Deliver with us</a></li>
                                                    ...
                                                    <div class="cont_rp_form">
                                                        <div class="row">
                                                            <div class="col-lg-10 offset-lg-1 col-sm-12">
                                                                <h6 class="reg_heding text-center mb-3">Registration of {{@$userType}}'s Delivery Person</h6>
                                                                <div class="addrs_div">
    ...
    $(document).ready(function(){
        ...
        $('.deliverPersonSignUpForm').validate({
            ...
            submitHandler: function(form) {
                ...
                $('.loader').show();
                $.ajax({
                    url:"{{url('/provider/deliverWithUsRegistration')}}",
                    type: "post",
        ...
        $("body").on('click','.vehicle_info_form_btn',function(){
            if ($('.vehicleInfoForm').valid()) {
                ...
                $.ajax({
                    url:"{{url('/provider/deliverWithUsRegistration/addVehicles')}}",
                    type: "post",
                    // data:$('.deliverPersonSignUpForm').serialize(),
                    ...
                    success:function(resp){
                        if (resp.status=='success') {
                            ...
                            // window.location.href= "{{url('/provider/profile')}}";
                            setInterval(function(){ window.location.href= "{{url('/provider/profile')}}"; }, 1000);
                        }else{
                            $('.loader').hide();
                            toastr.error('Oops, Something went wrong');
                        }
