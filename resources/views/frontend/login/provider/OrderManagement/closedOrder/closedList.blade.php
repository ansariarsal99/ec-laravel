...
@section('title','Closed Order List')
@section('content')
	            		...
	            		<section class="bread_top_sec">
	            			<div class="db_container">
		            			<div class="d-flex justify-content-between text-white pos_rel">
			            			...
			            			<h3>Closed Order List</h3>
			            			<nav class="bread_nav_sec">
										<ol class="breadcrumb">
										    <li class="breadcrumb-item"><a href="#">Home</a></li>
										    <li class="breadcrumb-item active"><a href="#">Closed Order List</a></li>
			            								...
			            								<div class="card_ttl d-flex align-items-center justify-content-between">
			            									<div class="chng_links">
			            										<ul type="none" class="d-flex align-items-center">
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='today') list-group-item active @endif"><a class="filter_day" seachData="today" href="{{url('/provider/closed/Order/list')}}?seachData=today">Today</a></li>

			            											<li class="li_filter_day @if(@$_GET['seachData'] =='yesterday') list-group-item active @endif"><a class="filter_day" seachData="yesterday" href="{{url('/provider/closed/Order/list')}}?seachData=yesterday">Yesterday</a></li>
                                                           <!-- list-group-item active -->
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='current_week') list-group-item active @endif"><a class="filter_day" seachData="current_week" href="{{url('/provider/closed/Order/list')}}?seachData=current_week">Current Week</a></li>
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='previous_week') list-group-item active @endif"><a class="filter_day" seachData="previous_week" href="{{url('/provider/closed/Order/list')}}?seachData=previous_week">Previous Week</a></li>
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='current_month') list-group-item active @endif"><a class="filter_day" seachData="current_month" href="{{url('/provider/closed/Order/list')}}?seachData=current_month">Current Month</a></li>
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='previous_month') list-group-item active @endif"><a class="filter_day" seachData="previous_month" href="{{url('/provider/closed/Order/list')}}?seachData=previous_month">Previous Month</a></li>
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='current_year') list-group-item active @endif"><a class="filter_day" seachData="current_year" href="{{url('/provider/closed/Order/list')}}?seachData=current_year">Current Year</a></li>
			            											<li class="li_filter_day @if(@$_GET['seachData'] =='previous_year') list-group-item active @endif"><a class="filter_day" seachData="previous_year" href="{{url('/provider/closed/Order/list')}}?seachData=previous_year">Previous Year</a></li>
			            										</ul>
			            									</div>
						            						<div class="">
