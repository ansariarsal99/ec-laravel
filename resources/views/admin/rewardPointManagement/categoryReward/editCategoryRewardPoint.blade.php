...
@section('title','Edit Category Reward Point')
@section('content')
 ...
 @include('admin.include.sidebar')
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Edit Category Reward Point</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="animated fadeIn">
            <form method="post" id="addRewrdForm" action="{{url('admin/rewardPointManagement/categoryReward/editReward/point/'.$rewardPointRecord['id'])}}">
              @csrf
                <div class="card">
                    <div class="card-header text-center">
                       <strong class="card-title"> Edit Category Reward Point</strong>
                    </div>
                    <div class="row">
                                ...
                                <form>
                                  ...
                                  <div class="form-group">
                                     <label>Select Category</label>
                                        <select disabled="" class="form-control countryIdClass chng_group" name="category_id" type="text" value="">
                                           <option selected disabled>Select Category</option>
                                               @if(isset($productCategories) && !empty($productCategories))
                                                   @foreach($productCategories as $productCategory)
                                                     <option value="{{@$productCategory['id']}}" @if($rewardPointRecord['category_id'] == $productCategory['id']) selected @endif>{{@$productCategory['name']}}</option>
                                                   @endforeach
                                               @endif
                                       </select>
                                   </div>
