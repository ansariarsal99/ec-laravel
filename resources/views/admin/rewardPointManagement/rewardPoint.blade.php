...
@section('title','Order Reward Point List')
@section('content')
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Order Reward Point List</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">Order Reward Point List</strong>
...
<script>
    $(function() {
        var t = $('#rewardPointList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('admin/rewardPointManagement/reward/point/Index')}}',
            columns: [
