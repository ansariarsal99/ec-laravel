...
@section('content')
    ...
    <div class="modal" id="role_add_modal">
        <form method="post" id="addCountryForm" action="{{url('admin/permissions/admins/add')}}">
                        ...
                        <div class="country_div">
                            <!-- <form> -->
                                <div class="form-group">
                                    <label>Type</label>
                                    <input type="text" name="type" class="form-control" placeholder="Enter Admin Type" maxlength="100">
                                </div>
                                <div class="form-group">
                                    <label>First Name</label>
                                    <input type="text" name="first_name" class="form-control" placeholder="Enter First Name" maxlength="100">
                                </div>
                               
                                <div class="form-group">
                                    <label>Last Name</label>
                                    <input type="text" name="last_name" class="form-control" placeholder="Enter Last Name" maxlength="100">
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" name="address" class="form-control" placeholder="Enter Address Here" maxlength="100">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="email" class="form-control" placeholder="Enter Email Here" maxlength="100">
                                </div>
                                <div class="form-group">
                                    <label>Phone No</label>
                                    <input type="number" name="phone_no" class="form-control" placeholder="Enter Phone No Here" maxlength="100">
                                </div>
                            {{-- <div class="form-group">
                                <label>Name</label>
                            ...
                            --}}
                              <div class="form-group">
                                <label>Role</label>
                                <select name="_id" id="role_id" class="form-control">
    ...
    <script>
        $(document).on('click','.del_btn',function(){
            ...
            if(confirmation == true){
                $.ajax({
                    url: "{{ url('admin/permissions/admins/delete') }}" + '/' + itemId,
                    type: 'POST',
