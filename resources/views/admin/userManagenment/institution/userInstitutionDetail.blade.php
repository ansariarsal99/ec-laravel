                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">User Detail(Institution)</li>
                            </ol>
                        </div>
                    </div>
                </div>
              ...
              @csrf
                <div class="card">
                    <div class="card-header text-center">
                       <strong class="card-title">User Detail(Institution)</strong>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input readonly=""  class="form-control mb-2" name="institution_name" value="{{@$userdata->institution_name}}" type="text">
                                            </div>
                                        </div>
                                    </div>
