...
@section('title','User Delivery Detail(Institution)')
@section('content')
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">User Delivery Detail(Institution)</li>
                            </ol>
                        </div>
                    </div>
                </div>
              ...
              @csrf
                <div class="card">
                    <div class="card-header text-center">
                       <strong class="card-title">User Delivery Detail(Institution)</strong>
                    </div>
