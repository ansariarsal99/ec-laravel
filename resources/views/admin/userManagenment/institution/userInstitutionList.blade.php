...
@section('title','User List(Institution)')
@section('content')
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">User List(Institution)</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">User List(Institution)</strong>
                   <!-- <a href="{{url('admin/subscriptionManagement/addSubscription')}}" class="btn btn-outline-danger" style="float:right;">Add New User</a> -->
                       <a href="{{url('admin/export/usertypeInstitution')}}" class="btn btn-outline-danger pull-right mr-2" style="float:right;">Export</a>
                    </div>
                    <div class="card-body">
...
<script>
    $(function() {
        var t = $('#userList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('admin/user/InstitutionuserListIndex')}}',
            columns: [
    ...
    function changeStatus(status, id){
                $.ajax({
                    url: "{{url('admin/userManagement/institution/status')}}",
                    type:'post',
