...
@section('title','Provider Seller List')
@section('content')
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Provider Seller List</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">Provider Seller List</strong>
...
<script>
    $(function() {
        var t = $('#sellerList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('admin/provider/sellerListIndex')}}',
            columns: [
    ...
    function changeStatus22(status, id){
                $.ajax({
                    url: "{{url('admin/provider/seller/status')}}",
                    type:'post',
