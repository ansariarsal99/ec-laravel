            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">All User List</strong>
...
<script>
    $(function() {
        var t = $('#userList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('admin/all/userList/index')}}',
            columns: [
                ...
                // { data: 'contact_name'.concat('contact_last_name'),       name: 'contact_name'.concat('contact_last_name')},
                { data: 'city',               name: 'city'},
                ...
                $('.status_button_toggle').each(function(i, e){
                    ...
                    $('#'+attr_id).btnSwitch({
                        ...
                        OnCallback: function(val) {
                            ...
                            // changeStatus33('active',attr_ral);
                        },
                        OffCallback: function(val) {
                            changeStatus22('inactive',attr_ral);
                            // changeStatus33('inactive',attr_ral);
                        },
                    });
                });
   ...
   function changeStatus33(certified_provider, id){
    ...
    function changeStatus(transaction_status, id){
                $.ajax({
                    url: "{{url('admin/userManagement/Designer/transaction_status')}}",
                    type:'post',
    ...
    function changeStatus22(status, id){
                $.ajax({
                    url: "{{url('admin/userManagement/Designer-status')}}",
                    type:'post',
