...
@section('title','Provider Contractor List')
@section('content')
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Provider Contractor List</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">Provider Contractor List</strong>
...
<script>
    $(function() {
        var t = $('#userList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('admin/provider/contractorListIndex')}}',
            columns: [
   ...
   function changeStatus33(certified_provider, id){
           ...
           function changeStatus(transaction_status, id){
                $.ajax({
                    url: "{{url('admin/provider/contractor/transactionStatus')}}",
                    type:'post',
