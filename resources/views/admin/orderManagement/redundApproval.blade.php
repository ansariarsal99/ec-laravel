                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Refund List</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">Refund List</strong>
...
<script>
    $(function() {
        var t = $('#rewardPointList').DataTable({
            ...
            serverSide: true,
            order: [ [0, 'desc'] ],
            ajax: '{{url('admin/refundApproval/ListIndex')}}',
            columns: [
                ...
                { data: 'approvedrefundStatus', name: 'approvedrefundStatus'},
                { data: 'refund_order_approved_by_admin',         name: 'refund_order_approved_by_admin'},
