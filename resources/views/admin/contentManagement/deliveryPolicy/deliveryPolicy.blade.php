 ...
 @include('admin.include.header')
    ...
    <div class="content">
        <div class="animated fadeIn">
           ...
           <!-- <div class="row">    -->
            <form method="post" id="termForm" action="{{url('admin/contentManagement/deliveryPolicy')}}">
              @csrf
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">Delivery & Policy</strong>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-md-2">
                            <div class="terms_page my-4">
                                <form>
                                    <label>Title</label>
                                    <input class="form-control mb-2" id="title" name="title" type="text"  value="{{@$deliveryPolicy->title}}"><br>
                                
                                    <label class="">Description</label>
                                    <input class="form-control" id="description_hidden_id" name="description" type="hidden">
                                    <textarea class="form-control textar" id="description_id" name="description_id">{{@$deliveryPolicy->description}}</textarea>
