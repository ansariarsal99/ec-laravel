 ...
 @include('admin.include.sidebar')
    ...
    <div class="content">
        <div class="animated fadeIn">
           ...
           <!-- <div class="row">    -->
            <form method="post" id="termForm" action="{{url('admin/productManagement/category/edit').'/'.Crypt::encrypt($category->id)}}"  enctype="multipart/form-data">
              @csrf
                <div class="card">
                        ...
                        <div class="col-lg-8 offset-md-2">
                          ...
                          <!--      <div class="form-group">
                                       ...
                                       <div class="pos_rel pic_top">
                                           <span class="img_edtt pos_rel vw_pro_img">
                                               ...
                                               <span class="edt_inpt">
                                                   ...
                                                   <input type="file" id="botonAjax" name="uploader" class="file_img">
                                               </span>
                                           </span>
                                       </div>
                                   </div>
                                 ...
                                 <div class="text-center  user-img vw_pro_img img_prof user-img my-4" id="admin_img">
                                       <img src={{$admin_image}} id="" name="image" value="{{$admin_image}}" class="img-fluid user-img">
                            ...
                            <input type="hidden" name="category_id" value="{{@$category->id}}">
                               <!-- adminBaseProductCategoryImgsPath -->
                               <!-- adminProductCategoryImgsPath -->
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textar" id="description_id" name="description_id">{{@$category->description}}</textarea>
