					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tbody>
								...
								<tr>
									<td align="center">
										<p style="margin-bottom:0px; font-size:18px; font-weight:bold; color: #505050;padding: 9px 30px 0px;text-align: left;">Hi, <span>{{ucfirst($new_name)}} {{$last_name}}</span></p>
										...
										<a href="{{$url}}" style="padding: 8px 30px; color: #cc3f2f; margin-top: 10px;text-decoration: none; letter-spacing: 1px; border: 5px double #9f9f9f; border-radius: 0px;font-size: 18px; display: inline-block;font-weight: 800;outline: none;">
										Reset Password</a>
									</td>
								</tr>
								<tr>
