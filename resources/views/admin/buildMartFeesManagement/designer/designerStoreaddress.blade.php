...
@section('title','provider Store Location(designer)')
@section('content')
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">provider Store Location(designer)</li>
                            </ol>
                        </div>
                    </div>
                </div>
              ...
              @csrf
                <div class="card">
                    <div class="card-header text-center">
                       <strong class="card-title">provider Store Location(designer)</strong>
                    </div>
