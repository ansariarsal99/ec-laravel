                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="javascript:;">Seller's List</a></li>
                   ...
                   <!--     <a href="{{url('admin/subscriptionManagement/addSubscription')}}" class="btn btn-outline-danger" style="float:right;">Add New User</a> -->
                    ...
                    <div class="card-body">
                        <div class="delvry_terms ordr-addr">
                            ...
                            <form id="buildMartFeeForm" method="POST" action="{{url('/admin/buildMartFees/seller/fees/'.$encSellerId)}}">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-10 offset-lg-1 col-sm-12">
                                        <div class="form-group fee_radio_btn radio_perc">
                                            <div class="custom-control custom-radio mb-3">
                                                <input type="radio" @if((!empty($user) && $user['assigned_build_mart_fees']=='yes' && $user['build_mart_fees_type']=='any_order_amount') || (!empty($user) && $user['assigned_build_mart_fees']=='no')) checked="" @endif class="custom-control-input fees_typ_rad" id="customRadio_new17" name="build_mart_fees_type" value="any_order_amount">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <div class="discount_wrap price_field mt-1 d-flex align-items-center">
                                                            <div class="discount_wrap amt_fields price_field d-flex">
                                                                @if(!empty($user) && $user['assigned_build_mart_fees']=='yes' && $user['build_mart_fees_type']=='any_order_amount')
                                        ...
                                        <div class="form-group mb-1 fee_radio_btn labl_amt d-flex justify-content-between align-items-center">
                                           <div class="custom-control custom-radio">
                                                <input type="radio" @if(!empty($user) && $user['assigned_build_mart_fees']=='yes' && $user['build_mart_fees_type']=='according_to_order_amount') checked="" @endif  class="custom-control-input fees_typ_rad acc_to_ordr_amt_cls" id="customRadio_new18" name="build_mart_fees_type" value="according_to_order_amount">
                                        ...
                                        <div class="del_fields fee_ranges">
                                            @if(!empty($user) && $user['assigned_build_mart_fees']=='yes' && $user['build_mart_fees_type']=='according_to_order_amount' && isset($feeRanges) && sizeof($feeRanges)>0)
                                          ...
                                          <!--  <div class="col-md-6">
                                                <input type="text" name="default_amount_build_mart" class="form-control" value="" placeholder="Enter default amount">
                                            </div><br> -->
                                            <div class="dafalt_feld">
                                                ...
                                                <div class="form-group ">
                                                   <!-- <label>Discount</label> -->
                                                   <div class="discount_wrap amt_fields price_field fees_fld d-flex">
                                                       <input type="text"  id="defaultAmount" name="default_amount_build_mart" value="{{$user['default_amount_build_mart']}}" placeholder="% or SR" class="discount_amt form-control more_prc_inpt inpt_txt">
                                                       <div class="price_percnt text-center default_amount__value_type">
                                                           <span  class=" default_type @if(@$user['default_amount_type']=='percent') active @endif" type="percent" value="">%</span>
                                                           <span  class=" default_type @if(@$user['default_amount_type']=='amount') active @endif" type="amount" value="">SR</span>
                                                       </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        <?php if(!empty($user) && $user['assigned_build_mart_fees']=='yes' && $user['build_mart_fees_type']=='according_to_order_amount' && isset($feeRanges) && sizeof($feeRanges)>0){ ?>
            // alert('if');
        ...
        $("body").on('click','.add_range',function(){
            ...
            $("input[id^=from_price_range_").each(function(){
                ...
                $(this).rules("add", {
                    ...
                    remote: {
                        url: "{{url('/admin/buildMartFees/range/check')}}",
                        data:{
                            range:function(){
                                return ths.val();
                            },
        ...
        $("body").on('keyup','.range_cls',function(){
            ...
            // alert(part);
            $.ajax({
                url: "{{url('/admin/buildMartFees/range/add')}}",
                type:'post',
                data: {'value': value,'part':part,'key':key, userId:userId},
