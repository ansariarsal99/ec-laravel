...
@section('title','provider Store Location(Consultant)')
@section('content')
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">provider Store Location(Consultant)</li>
                            </ol>
                        </div>
                    </div>
                </div>
              ...
              @csrf
                <div class="card">
                    <div class="card-header text-center">
                       <strong class="card-title">provider Store Location(Consultant)</strong>
                    </div>
