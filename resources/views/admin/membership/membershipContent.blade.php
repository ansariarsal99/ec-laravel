...
@section('title','Membership Content')
@section('content')
 ...
 @include('admin.include.header')
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Membership Content</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
    ...
    <div class="content">
        <div class="animated fadeIn">
           ...
           <!-- <div class="row">    -->
            <form method="post" id="termForm" action="{{url('admin/membership/membershipContent')}}">
              @csrf
                <div class="card">
                    <div class="card-header">
                       <strong class="card-title">Membership Content</strong>
                    </div>
                    <div class="row">
                            ...
                            <div class="terms_page my-4">
                                <form>
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input class="form-control mb-2" id="title" name="title" type="text"  value="{{@$terms_condition->title}}">
                                    </div>
                                     <div class="form-group">
