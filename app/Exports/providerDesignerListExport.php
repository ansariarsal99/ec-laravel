...
class providerDesignerListExport implements FromCollection,WithHeadings,ShouldAutoSize
{
    /**
    ...
    */
    public function collection()
    {
        ...
        $count = User::where('user_type_id',3)->where('complete_profile','yes')->count();
    	// dd($count - 2000);
    	$offset = 0;
    	$limit = 1000;
    	$arr_to_return = [];
