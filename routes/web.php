...
//////////////////oriduct Management////////////////
  ...
  /////////////EndReward//////////////////////////////////////
   ...
   ////////////////////SellingMaterialController/////////////////////////////
    ...
    Route::match(['get','post'],'permissions/admins','PermissionController@admins');
    Route::match(['get','post'],'permissions/admins/delete/{id}','PermissionController@deleteAdmins')->name('admin.admins.delete');
    Route::match(['get','post'],'permissions/admins/add','PermissionController@addAdmins');
